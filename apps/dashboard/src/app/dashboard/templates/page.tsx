...
export default function TemplatesPage() {
  ...
  const {
    ...
    used: templateUsed,
    max: templateLimit,
  } = templateLimitState(plan, isPremium, customCount);
    ...
    <div>
      ...
      {!isPremium && (
        <PlanLimitBanner
          ...
          description={
            allowCreate
              ? 'Las plantillas de sistema no cuentan para el límite.'
              : limitMessage('plantillas personalizadas', templateUsed, templateLimit)
          }
        />
      )}
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label>HTML</Label>
                  <textarea
                    className="min-h-[180px] w-full rounded-2xl border border-border/80 bg-white/80 p-4 font-mono text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-gold/30 disabled:opacity-60"
